...
ClassImp(genfit::R3BGTPCSpacepointMeasurement)
  ...
  R3BGTPCSpacepointMeasurement::R3BGTPCSpacepointMeasurement(
      const R3BGTPCHitClusterData *detHit, const TrackCandHit *hit)
  ...
  AbsMeasurement *R3BGTPCSpacepointMeasurement::clone() const {
    return new R3BGTPCSpacepointMeasurement(*this);
  }
