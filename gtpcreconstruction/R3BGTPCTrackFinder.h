...
private:
  tc_params inputParams{
      .s = 0.3, .k = 19, .n = 2, .m = 15, .r = 2, .a = 0.03, .t = 4.0};
...
public:
  ...
  std::unique_ptr<R3BGTPCTrackData>
  clustersToTrack(PointCloud &cloud, const std::vector<cluster_t> &clusters,
