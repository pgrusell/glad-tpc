...
R3BGTPCHit2Track::R3BGTPCHit2Track()
    : FairTask("R3B GTPC Hit to Track")
      ...
      //, fHit_Par(NULL)
      ,
      fHitCA(NULL), fTrackCA(NULL), fOnline(kFALSE) {}
...
//[[deprecated]]
// R3BGTPCTrackData* R3BGTPCHit2Track::AddTrackData(std::size_t trackId,
...
//  return new (clref[size]) R3BGTPCTrackData(trackId,
//  std::move(hitArray),std::move(*hitClusterArray));
//}
